(() => {
    ...
    const colorRules = [
        ...
        ["red", "Красные", /(^|[^а-яё])красн[а-яё]*/i],
        ["blue", "Синие", /(^|[^а-яё])син[а-яё]*/i],
        ["green", "Зелёные", /(^|[^а-яё])зел[её]н[а-яё]*/i],
        ["yellow", "Жёлтые", /(^|[^а-яё])ж[её]лт[а-яё]*/i],
        ["orange", "Оранжевые", /(^|[^а-яё])оранж[а-яё]*/i],
        ["pink", "Розовые", /(^|[^а-яё])розов[а-яё]*/i],
        ["purple", "Фиолетовые", /(^|[^а-яё])фиолет[а-яё]*/i],
        ["brown", "Коричневые", /(^|[^а-яё])коричнев[а-яё]*/i],
        ["gray", "Серые", /(^|[^а-яё])сер[а-яё]*/i],
        ["light_blue", "Голубые", /(^|[^а-яё])голуб[а-яё]*/i],
        ["light_green", "Салатовые", /(^|[^а-яё])салатов[а-яё]*/i],
        ["light_gray", "Светло-серые", /(^|[^а-яё])светло[\s-]*сер[а-яё]*/i],
        [
            "light_pink",
            "Светло-розовые",
            /(^|[^а-яё])светло[\s-]*розов[а-яё]*/i,
        ],
        ["dark_red", "Тёмно-красные", /(^|[^а-яё])т[её]мно[\s-]*красн[а-яё]*/i],
        ["dark_blue", "Тёмно-синие", /(^|[^а-яё])т[её]мно[\s-]*син[а-яё]*/i],
        [
            "dark_green",
            "Тёмно-зелёные",
            /(^|[^а-яё])т[её]мно[\s-]*зел[её]н[а-яё]*/i,
        ],
        ["dark_gray", "Тёмно-серые", /(^|[^а-яё])т[её]мно[\s-]*сер[а-яё]*/i],
        [
            "dark_purple",
            "Тёмно-фиолетовые",
            /(^|[^а-яё])т[её]мно[\s-]*фиолет[а-яё]*/i,
        ],
        ["cyan", "Бирюзовые", /(^|[^а-яё])бирюз[а-яё]*/i],
        ["aqua", "Аквамариновые", /(^|[^а-яё])аквамарин[а-яё]*/i],
        ["teal", "Сине-зелёные", /(^|[^а-яё])сине[\s-]*зел[её]н[а-яё]*/i],
        ["lime", "Лаймовые", /(^|[^а-яё])лайм[а-яё]*/i],
        ["magenta", "Пурпурные", /(^|[^а-яё])пурпур[а-яё]*/i],
        ["violet", "Сиреневые", /(^|[^а-яё])сирен[а-яё]*/i],
        ["indigo", "Индиго", /(^|[^а-яё])индиго([^а-яё]|$)/i],
        ["beige", "Бежевые", /(^|[^а-яё])беж[а-яё]*/i],
        ["cream", "Кремовые", /(^|[^а-яё])кремов[а-яё]*/i],
        ["gold", "Золотые", /(^|[^а-яё])золот[а-яё]*/i],
        ["silver", "Серебряные", /(^|[^а-яё])серебр[а-яё]*/i],
        ["maroon", "Бордовые", /(^|[^а-яё])бордов[а-яё]*/i],
        ["navy", "Тёмно-синие", /(^|[^а-яё])нави([^а-яё]|$)/i],
        ["coral", "Коралловые", /(^|[^а-яё])кораллов[а-яё]*/i],
        ["turquoise", "Бирюзовые", /(^|[^а-яё])туркуаз[а-яё]*/i],
        ["lavender", "Лавандовые", /(^|[^а-яё])лавандов[а-яё]*/i],
        ["mint", "Мятные", /(^|[^а-яё])мятн[а-яё]*/i],
        ["olive", "Оливковые", /(^|[^а-яё])оливков[а-яё]*/i],
    ];
